...
/**
 * 这部分可以对照百度百科理解
 * https://baike.baidu.com/item/Paillier%E5%8A%A0%E5%AF%86/20388831?fr=aladdin
 * 注：
 * gcd求最大公约数
 *
...
public class Paillier {
    ...
    public void KeyGeneration(int bitLengthVal, int certainty) {
        ...
        g = new BigInteger("2");
        //subtract 减法操作   multiply乘法操作  divide除法操作  g.modPow(a,b)=  g^a  mod b
        //g.modInverse(n)  =(1/g  )mod(n)
    ...
    public static void main(String[] str) {
        ...
        System.out.println("加密数字1->"+em1);
        System.out.println("加密数字2->"+em2);
        /* printout decrypted text */
        System.out.println("直接解密数字1->"+paillier.Decryption(em1).toString());
        System.out.println("直接解密数字2->"+paillier.Decryption(em2).toString());
        ...
        System.out.println("original sum: " + sum_m1m2.toString()+"原始结果"+m1.add(m2).toString());
        // em1+em2，求密文数值的乘
        BigInteger product_em1em2 = em1.multiply(em2).mod(paillier.nsquare);
        System.out.println("密文乘积 " + product_em1em2.toString());
        System.out.println("对密文乘积解密: " + paillier.Decryption(product_em1em2).toString());
        System.out.println("上面可以验证加密后的乘积等于原来的求和");
        ...
        System.out.println("em1^m2  mod n^2-> " + expo_em1m2.toString());
        System.out.println("解密上面: " + paillier.Decryption(expo_em1m2).toString());
        ...
        BigInteger t4 = new BigInteger("50");System.out.println(t3.toString());
        ...
        BigInteger et4 = p.Encryption(t4);System.out.println(et4.toString());
        BigInteger sum = new BigInteger("1");
        sum = p.cipher_add(sum, et1);
        sum = p.cipher_add(sum, et2);
        sum = p.cipher_add(sum, et3);
        sum=p.cipher_add(sum,et4);
