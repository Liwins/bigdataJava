...
public class  TestHa{
    ...
    public static class RjReduce extends Reducer<User,NullWritable,User,NullWritable> {
        @Override
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setJar("E:\\injipro\\mapred\\hive\\target\\iotsp.jar");
...
//        job.setPartitionerClass(UserPartation.class);
        ...
        Path input=new Path("/rj/input");
        Path output=new Path("/user/hive/warehouse/zhizhan03.db/rjuser");
