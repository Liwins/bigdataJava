...
import cn.riversky.weblog.bean.PageViewsBean;
import cn.riversky.weblog.bean.VisitBean;
...
public class ClickStreamVisit {
    ...
    static class ClickStreamVisitReducer extends Reducer<Text, PageViewsBean, NullWritable, VisitBean> {
        @Override
        protected void reduce(Text key, Iterable<PageViewsBean> pvBeans, Context context) throws IOException, InterruptedException {
