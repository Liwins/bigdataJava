 ...
 */
public class WebLogBean implements Writable,Comparable {
    ...
    public int compareTo(Object o) {
        ...
        try {
            Date d1 = df.parse(this.getTime_local());
            Date d2=null;
            if(o instanceof WebLogBean){
                d2 = df.parse(((WebLogBean) o).getTime_local());
            }else return 0;
            if (d1 == null || d2 == null)
                return 0;
