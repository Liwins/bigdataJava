 ...
 */
public class PageViewsBean implements Writable ,Comparable{
    ...
    public int compareTo(Object o) {
        if(o instanceof PageViewsBean){
            PageViewsBean two= (PageViewsBean) o;
            return this.getStep()>two.getStep()?1:-1;
        }
        return -1;
    }
}
